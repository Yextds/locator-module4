  ...
  return (
    <div className='relative z-10'>
      <Transition
        ...
        leaveTo="opacity-0"
      >
        <div className='absolute z-50 bottom-12 -inset-x-24 w-60 h-50 bg-white rounded-md shadow-sm shadow-stone-400/5 p-4 gap-5 align-middle'>
          <div className='my-auto mx-auto flex flex-row'>
          <svg   onClick={() => setShowCard(false)} xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" overflow="visible" stroke="black" stroke-width="10" stroke-linecap="round">
           <line x2="10" y2="10" />
            <line x1="10" y2="10" />
            </svg>
